...
export function renderEquipe(root, state, actions) {
  const wrap = document.createElement('div');
  wrap.innerHTML = `
    <h1 class="page-title">Équipe &amp; Points de vente</h1>
    <p class="page-sub">Gérez la liste des vendeurs et des points de vente utilisés dans les objectifs et le registre d'abonnements.</p>
  ...
  wrap.addEventListener('click', (e) => {
    ...
    } else if (e.target.dataset.removeOutlet) {
